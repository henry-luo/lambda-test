...
[![Coverage Status](../support/images/codecov_badge.svg)](https://codecov.io/gh/sindresorhus/execa)
...
<div align="center">
	<p>
		...
		<a href="https://coderabbit.ai?utm_source=sindre&utm_medium=execa">
			<img width="300" src="../support/images/sindresorhus_coderabbit-logo.png" alt="CodeRabbit logo">
		</a>
		<br>
		<br>
		<br>
		<a href="https://kruu.com">
			<picture>
				<source srcset="../support/images/sindresorhus_kruu-logo-dark.svg" media="(prefers-color-scheme: dark)" width="260">
				<source srcset="../support/images/sindresorhus_kruu-logo-light.svg" media="(prefers-color-scheme: light)" width="260">
				<img src="../support/images/sindresorhus_kruu-logo-light.svg" width="260"alt="KRUU logo">
			</picture>
		</a>
		<br>
		<br>
		...
		<a href="https://depot.dev?utm_source=github&utm_medium=sindresorhus">
			<div>
				<picture>
					<source width="180" media="(prefers-color-scheme: dark)" srcset="../support/images/sindresorhus_depot-logo-dark.svg">
					<source width="180" media="(prefers-color-scheme: light)" srcset="../support/images/sindresorhus_depot-logo-light.svg">
					<img width="180" src="../support/images/sindresorhus_depot-logo-light.svg" alt="Depot logo">
				</picture>
			</div>
