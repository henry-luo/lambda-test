...
[![NPM version](../support/images/img.shields.io_npm_v_ts-node.svg)](https://npmjs.org/package/ts-node)
[![NPM downloads](../support/images/img.shields.io_npm_dm_ts-node.svg)](https://npmjs.org/package/ts-node)
[![Build status](../support/images/img.shields.io_github_actions_workflow_status_TypeStrong_ts-node_continuous-integration.yml.svg)](https://github.com/TypeStrong/ts-node/actions?query=workflow%3A%22Continuous+Integration%22)
[![Test coverage](../support/images/codecov_badge.svg)](https://codecov.io/gh/TypeStrong/ts-node)
