...
async function extractAllTestFiles(category = null, forceRegenerate = false) {
...
Examples:
  node extract_browser_references.js                                    # Extract all test files from all categories
...
`);
    ...
    try {
        if (singleFile) {
            ...
            // Batch mode
            await extractAllTestFiles(category, forceRegenerate);
